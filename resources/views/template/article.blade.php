...
<head>
  ...
  <style>
    .sectionBG {
      background-image: linear-gradient(to bottom, rgba(255,255,255,0.7), rgba(0,0,0,1)), url(@section('jumbotronImage')@show);
    }
...
<body>
  ...
  <div class="jumbotron jumbotron-fluid text-center sectionBG">
        <h1 class="display-3 pt-5 text-light">@section('title')@show</h1>
        <p class="lead text-light">@section('subtitle')@show</p>
  </div>
  </div>
